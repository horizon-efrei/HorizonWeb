<template>
  <div class="carousel relative rounded relative overflow-hidden shadow-xl">
    <div class="carousel-inner relative overflow-hidden w-full">
      ...
      >
      <div
        class="carousel-item absolute opacity-0 bg-center h-52"
        style="background-image: url(https://mdbootstrap.com/img/new/slides/052.jpg)"
      />
      ...
      >
      <div
        class="carousel-item absolute opacity-0 bg-center h-full"
        style="background-image: url(https://mdbootstrap.com/img/new/slides/043.jpg)"
      />
      ...
      >
      <div
        class="carousel-item absolute opacity-0 h-full"
        style="background-image: url(https://mdbootstrap.com/img/new/slides/054.jpg)"
      />
      <!-- <label for="carousel-2"
